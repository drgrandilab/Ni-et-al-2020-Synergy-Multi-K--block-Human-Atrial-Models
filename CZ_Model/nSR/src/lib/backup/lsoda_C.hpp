...
* Update: to get rid of dependecy of the solver on a class of ODE, replaced with simple C function interface, to make it easier to use
* for those who only want to use c functions rather than classes or cpp.
* Still, you need to compile with g++/icpc, with -std=c++11
* Haibo Ni <haibo.ni0822@gmail.com>
* Wed 17 Feb 2016 16:06:01 GMT
...
public:
    ...
    /*
     ...
     hmin = rwork7
     */
    void lsoda_Old(void (*f)(double, double *, double *, void *), int m_neq, double *y, double *t, double tout, int itol, double *rtol, double *atol,
    ...
    void lsoda(void (*f)(double, double *, double *, void *), double *y, double *t, double tout, void *_data)
    {
...
/*                if (istate == 3)
        ...
        if (istate == 1) {
            ...
            // std::cout << " allocating memory at t = " << *t << std::endl;
            sqrteta = sqrt(ETA);
            meth = 1;
            g_nyh = nyh = n;
            g_lenyh = lenyh = 1 + std::max(mxordn, mxords);
     ...
     */
    void stoda( int m_neq, double *y, void (*f)(double, double *, double *, void *), void *_data )
    {
     ...
     */
    void prja( int m_neq, double *y, void (*f)(double, double *, double *, void *), void *_data )
    {
        int             i, ier, j;
     ...
     */
    void correction(int m_neq, double *y, void (*f)(double, double *, double *, void *), int *corflag, double pnorm, double *del, double *delp, double *told,
...
private:
    ...
    const double sm1[13] = { 0.0, 0.5, 0.575, 0.55, 0.45, 0.35, 0.25, 0.2, 0.15, 0.1, 0.075, 0.05, 0.025 };
