...
double Updated_CNZ_New_IKur_ODE(double dt, double Istim, SingleCellPara & het, double *state) {
	...
	tau = 1000.0*(0.025635 * exp (-((V + 52.45) / 15.8827) * 2) + 0.01414);
	...
	IKur = het.GKur * Cm * CNZ_gkur * (4.5128 + 1.899769 / (1.0 + exp((V - 20.5232) / (-8.26597)))) * (1 - IKur_BO - IKur_BC) * CNZ_a * (0.65 * CNZ_i + 0.35 * CNZ_is) * (V - Ek);
