function ham_ina_isk_drug_model_main_single(CPU_ID, rate, AF, para,model_ID)
...
APfile = sprintf('CPU_ID_%d_test.dat', CPU_ID);
...
file_AP = sprintf('AP_Cell_%d.mat', model_ID);
