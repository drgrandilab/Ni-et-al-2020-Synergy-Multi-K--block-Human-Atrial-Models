...
IK2p = S_GK2P * GK2p * o_k2p * (y(39) - ek);
...
I_sk_junc =  Fjunc*S_GSK* GSK * O_SK_j * (1.0 / (1.0 + exp( (y(39) - ek + 120) / 45.0))) * (y(39) - ek);
I_sk_sl =  Fsl*S_GSK* GSK * O_SK_sl * (1.0 / (1.0 + exp( (y(39) - ek + 120) / 45.0))) * (y(39) - ek);
I_sk = I_sk_junc+I_sk_sl;
